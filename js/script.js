...
function tagClickHandler(event){
  ...
  const tagList = document.querySelectorAll('a.active[href^="#tag-"]');
...
function authorClickHandler(event){
  ...
  /* make new constant named "clickedElement" and ge it the value of "this" */
